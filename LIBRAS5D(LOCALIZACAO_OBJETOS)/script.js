...
- Array com todos os sinais de localização/objetos
- Cada sinal tem: id, título, vídeo, alt, contexto
============================================ */
const signals = [
    { id: 1, title: "COLHER", video: "LOCALIZACAO_OBJETOS/1_COLHER.mp4", alt: "Avatar fazendo o sinal de Colher", context: "Usado para se referir à colher" },
    { id: 2, title: "COPO", video: "LOCALIZACAO_OBJETOS/2_COPO.mp4", alt: "Avatar fazendo o sinal de Copo", context: "Usado para se referir ao copo" },
    { id: 3, title: "GARFO", video: "LOCALIZACAO_OBJETOS/3_GARFO.mp4", alt: "Avatar fazendo o sinal de Garfo", context: "Usado para se referir ao garfo" },
    { id: 4, title: "FACA", video: "LOCALIZACAO_OBJETOS/4_FACA.mp4", alt: "Avatar fazendo o sinal de Faca", context: "Usado para se referir à faca" },
    { id: 5, title: "PRATO", video: "LOCALIZACAO_OBJETOS/5_PRATO.mp4", alt: "Avatar fazendo o sinal de Prato", context: "Usado para se referir ao prato" },
    { id: 6, title: "ESCOVA DE DENTE", video: "LOCALIZACAO_OBJETOS/6_ESCOVA_DE_DENTE.mp4", alt: "Avatar fazendo o sinal de Escova de Dente", context: "Usado para se referir à escova de dente" },
    { id: 7, title: "PAPEL HIGIÊNICO", video: "LOCALIZACAO_OBJETOS/7_PAPEL_HIGIÊNICO.mp4", alt: "Avatar fazendo o sinal de Papel Higiênico", context: "Usado para se referir ao papel higiênico" },
    { id: 8, title: "TOALHA", video: "LOCALIZACAO_OBJETOS/8_TOALHA.mp4", alt: "Avatar fazendo o sinal de Toalha", context: "Usado para se referir à toalha" },
    { id: 9, title: "SABONETE", video: "LOCALIZACAO_OBJETOS/9_SABONETE.mp4", alt: "Avatar fazendo o sinal de Sabonete", context: "Usado para se referir ao sabonete" },
    { id: 10, title: "RÁPIDO (PRESSA)", video: "LOCALIZACAO_OBJETOS/10_RÁPIDO_PRESSA.mp4", alt: "Avatar fazendo o sinal de Rápido", context: "Usado para indicar rapidez ou pressa" },
    { id: 11, title: "DEVAGAR", video: "LOCALIZACAO_OBJETOS/11_DEVAGAR.mp4", alt: "Avatar fazendo o sinal de Devagar", context: "Usado para indicar lentidão" },
    { id: 12, title: "LIMPO", video: "LOCALIZACAO_OBJETOS/12_LIMPO.mp4", alt: "Avatar fazendo o sinal de Limpo", context: "Usado para indicar limpeza" },
    { id: 13, title: "SUJO", video: "LOCALIZACAO_OBJETOS/13_SUJO.mp4", alt: "Avatar fazendo o sinal de Sujo", context: "Usado para indicar sujeira" },
    { id: 14, title: "ALEGRE", video: "LOCALIZACAO_OBJETOS/14_ALEGRE.mp4", alt: "Avatar fazendo o sinal de Alegre", context: "Usado para indicar alegria" },
    { id: 15, title: "TRISTE", video: "LOCALIZACAO_OBJETOS/15_TRISTE.mp4", alt: "Avatar fazendo o sinal de Triste", context: "Usado para indicar tristeza" },
    { id: 16, title: "BONITO", video: "LOCALIZACAO_OBJETOS/16_BONITO.mp4", alt: "Avatar fazendo o sinal de Bonito", context: "Usado para indicar beleza" },
    { id: 17, title: "FEIO", video: "LOCALIZACAO_OBJETOS/17_FEIO.mp4", alt: "Avatar fazendo o sinal de Feio", context: "Usado para indicar feiura" },
    { id: 18, title: "IGUAL", video: "LOCALIZACAO_OBJETOS/18_IGUAL.mp4", alt: "Avatar fazendo o sinal de Igual", context: "Usado para indicar igualdade" },
    { id: 19, title: "DIFERENTE", video: "LOCALIZACAO_OBJETOS/19_DIFERENTE.mp4", alt: "Avatar fazendo o sinal de Diferente", context: "Usado para indicar diferença" },
    { id: 20, title: "N-U-N-C-A", video: "LOCALIZACAO_OBJETOS/20_NUNCA.mp4", alt: "Avatar fazendo o sinal de Nunca", context: "Usado para indicar nunca" },
    { id: 21, title: "SEMPRE", video: "LOCALIZACAO_OBJETOS/21_SEMPRE.mp4", alt: "Avatar fazendo o sinal de Sempre", context: "Usado para indicar sempre" },
    { id: 22, title: "LONGE", video: "LOCALIZACAO_OBJETOS/22_LONGE.mp4", alt: "Avatar fazendo o sinal de Longe", context: "Usado para indicar distância" },
    { id: 23, title: "PERTO", video: "LOCALIZACAO_OBJETOS/23_PERTO.mp4", alt: "Avatar fazendo o sinal de Perto", context: "Usado para indicar proximidade" },
    { id: 24, title: "FÁCIL", video: "LOCALIZACAO_OBJETOS/24_FÁCIL.mp4", alt: "Avatar fazendo o sinal de Fácil", context: "Usado para indicar facilidade" },
    { id: 25, title: "DIFÍCIL", video: "LOCALIZACAO_OBJETOS/25_DIFÍCIL.mp4", alt: "Avatar fazendo o sinal de Difícil", context: "Usado para indicar dificuldade" },
    { id: 26, title: "EMBAIXO", video: "LOCALIZACAO_OBJETOS/26_EMBAIXO.mp4", alt: "Avatar fazendo o sinal de Embaixo", context: "Usado para indicar posição inferior" },
    { id: 27, title: "EM CIMA", video: "LOCALIZACAO_OBJETOS/27_EM_CIMA.mp4", alt: "Avatar fazendo o sinal de Em Cima", context: "Usado para indicar posição superior" },
    { id: 28, title: "DIREITA", video: "LOCALIZACAO_OBJETOS/28_DIREITA.mp4", alt: "Avatar fazendo o sinal de Direita", context: "Usado para indicar direção direita" },
    { id: 29, title: "ESQUERDA", video: "LOCALIZACAO_OBJETOS/29_ESQUERDA.mp4", alt: "Avatar fazendo o sinal de Esquerda", context: "Usado para indicar direção esquerda" },
    { id: 30, title: "JUNTO", video: "LOCALIZACAO_OBJETOS/30_JUNTO.mp4", alt: "Avatar fazendo o sinal de Junto", context: "Usado para indicar companhia" },
    { id: 31, title: "SOZINHO", video: "LOCALIZACAO_OBJETOS/31_SOZINHO.mp4", alt: "Avatar fazendo o sinal de Sozinho", context: "Usado para indicar solidão" },
    { id: 32, title: "ONDE? (LUGAR)", video: "LOCALIZACAO_OBJETOS/32_ONDE_LUGAR.mp4", alt: "Avatar fazendo o sinal de Onde?", context: "Usado para perguntar sobre lugar" },
    { id: 33, title: "TEMPO (HORAS)", video: "LOCALIZACAO_OBJETOS/33_TEMPO_HORAS.mp4", alt: "Avatar fazendo o sinal de Tempo", context: "Usado para se referir a tempo ou horas" }
];
