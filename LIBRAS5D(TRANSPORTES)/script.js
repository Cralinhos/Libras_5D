/* ============================================
   ...
   - Array com todos os sinais de transportes
   - Cada sinal tem: id, título, vídeo, alt, contexto
   ============================================ */
const signals = [
    { id: 1, title: "ÔNIBUS", video: "TRANSPORTES/1_ÔNIBUS.mp4", alt: "Avatar fazendo o sinal de Ônibus", context: "Usado para se referir ao ônibus" },
    { id: 2, title: "CARRO", video: "TRANSPORTES/2_CARRO.mp4", alt: "Avatar fazendo o sinal de Carro", context: "Usado para se referir au carro" },
    { id: 3, title: "CAMINHÃO", video: "TRANSPORTES/3_CAMINHÃO.mp4", alt: "Avatar fazendo o sinal de Caminhão", context: "Usado para se referir ao caminhão" },
    { id: 4, title: "BICICLETA", video: "TRANSPORTES/4_BICICLETA.mp4", alt: "Avatar fazendo o sinal de Bicicleta", context: "Usado para se referir à bicicleta" },
    { id: 5, title: "MOTO", video: "TRANSPORTES/5_MOTO.mp4", alt: "Avatar fazendo o sinal de Moto", context: "Usado para se referir à motocicleta" },
    { id: 6, title: "METRÔ", video: "TRANSPORTES/6_METRÔ.mp4", alt: "Avatar fazendo o sinal de Metrô", context: "Usado para se referir ao metrô" },
    { id: 7, title: "AVIÃO", video: "TRANSPORTES/7_AVIÃO.mp4", alt: "Avatar fazendo o sinal de Avião", context: "Usado para se referir ao avião" },
    { id: 8, title: "TREM", video: "TRANSPORTES/8_TREM.mp4", alt: "Avatar fazendo o sinal de Trem", context: "Usado para se referir ao trem" },
    { id: 9, title: "BARCO", video: "TRANSPORTES/9_BARCO.mp4", alt: "Avatar fazendo o sinal de Barco", context: "Usado para se referir ao barco" },
    { id: 10, title: "RODOVIÁRIA", video: "TRANSPORTES/10_RODOVIÁRIA.mp4", alt: "Avatar fazendo o sinal de Rodoviária", context: "Usado para se referir à rodoviária" },
    { id: 11, title: "AEROPORTO", video: "TRANSPORTES/11_AEROPORTO.mp4", alt: "Avatar fazendo o sinal de Aeroporto", context: "Usado para se referir ao aeroporto" },
    { id: 12, title: "ATENÇÃO", video: "TRANSPORTES/12_ATENÇÃO.mp4", alt: "Avatar fazendo o sinal de Atenção", context: "Usado para chamar atenção" },
    { id: 13, title: "PERIGOSO", video: "TRANSPORTES/13_PERIGOSO.mp4", alt: "Avatar fazendo o sinal de Perigoso", context: "Usado para indicar perigo" },
    { id: 14, title: "CHORAR", video: "TRANSPORTES/14_CHORAR.mp4", alt: "Avatar fazendo o sinal de Chorar", context: "Usado para indicar choro" },
    { id: 15, title: "SABER", video: "TRANSPORTES/15_SABER.mp4", alt: "Avatar fazendo o sinal de Saber", context: "Usado para indicar conhecimento" },
    { id: 16, title: "NÃO SABER", video: "TRANSPORTES/16_NÃO_SABER.mp4", alt: "Avatar fazendo o sinal de Não Saber", context: "Usado para indicar desconhecimento" },
    { id: 17, title: "MORAR/CASA", video: "TRANSPORTES/17_MORAR_CASA.mp4", alt: "Avatar fazendo o sinal de Morar/Casa", context: "Usado para indicar moradia ou casa" },
    { id: 18, title: "PERDER", video: "TRANSPORTES/18_PERDER.mp4", alt: "Avatar fazendo o sinal de Perder", context: "Usado para indicar perda" },
    { id: 19, title: "PROCURAR", video: "TRANSPORTES/19_PROCURAR.mp4", alt: "Avatar fazendo o sinal de Procurar", context: "Usado para indicar busca" },
    { id: 20, title: "ENCONTRAR/ACHAR", video: "TRANSPORTES/20_ENCONTRAR_ACHAR.mp4", alt: "Avatar fazendo o sinal de Encontrar/Achar", context: "Usado para indicar que encontrou algo" },
    { id: 21, title: "MOSTRAR", video: "TRANSPORTES/21_MOSTRAR.mp4", alt: "Avatar fazendo o sinal de Mostrar", context: "Usado para indicar ação de mostrar" },
    { id: 22, title: "AJUDAR", video: "TRANSPORTES/22_AJUDAR.mp4", alt: "Avatar fazendo o sinal de Ajudar", context: "Usado para indicar ajuda" }
];
