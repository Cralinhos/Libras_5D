/* ============================================
   ...
   - Array com todos os sinais de partes da casa/móveis
   - Cada sinal tem: id, título, vídeo, alt, contexto
   ============================================ */
const signals = [
    { id: 1, title: "SALA", video: "CASA_MOVEIS/1_SALA.mp4", alt: "Avatar fazendo o sinal de Sala", context: "Usado para se referir à sala" },
    { id: 2, title: "BANHEIRO", video: "CASA_MOVEIS/2_BANHEIRO.mp4", alt: "Avatar fazendo o sinal de Banheiro", context: "Usado para se referir ao banheiro" },
    { id: 3, title: "COZINHA", video: "CASA_MOVEIS/3_COZINHA.mp4", alt: "Avatar fazendo o sinal de Cozinha", context: "Usado para se referir à cozinha" },
    { id: 4, title: "GELADEIRA", video: "CASA_MOVEIS/4_GELADEIRA.mp4", alt: "Avatar fazendo o sinal de Geladeira", context: "Usado para se referir à geladeira" },
    { id: 5, title: "MESA", video: "CASA_MOVEIS/5_MESA.mp4", alt: "Avatar fazendo o sinal de Mesa", context: "Usado para se referir à mesa" },
    { id: 6, title: "FOGÃO", video: "CASA_MOVEIS/6_FOGÃO.mp4", alt: "Avatar fazendo o sinal de Fogão", context: "Usado para se referir ao fogão" },
    { id: 7, title: "CAMA", video: "CASA_MOVEIS/7_CAMA.mp4", alt: "Avatar fazendo o sinal de Cama", context: "Usado para se referir à cama" },
    { id: 8, title: "TELEVISÃO", video: "CASA_MOVEIS/8_TELEVISÃO.mp4", alt: "Avatar fazendo o sinal de Televisão", context: "Usado para se referir à televisão" },
    { id: 9, title: "PORTA", video: "CASA_MOVEIS/9_PORTA.mp4", alt: "Avatar fazendo o sinal de Porta", context: "Usado para se referir à porta" },
    { id: 10, title: "JANELA", video: "CASA_MOVEIS/10_JANELA.mp4", alt: "Avatar fazendo o sinal de Janela", context: "Usado para se referir à janela" },
    { id: 11, title: "APARTAMENTO", video: "CASA_MOVEIS/11_APARTAMENTO.mp4", alt: "Avatar fazendo o sinal de Apartamento", context: "Usado para se referir ao apartamento" },
    { id: 12, title: "RUA", video: "CASA_MOVEIS/12_RUA.mp4", alt: "Avatar fazendo o sinal de Rua", context: "Usado para se referir à rua" },
    { id: 13, title: "GRANDE", video: "CASA_MOVEIS/13_GRANDE.mp4", alt: "Avatar fazendo o sinal de Grande", context: "Usado para indicar tamanho grande" },
    { id: 14, title: "PEQUENO", video: "CASA_MOVEIS/14_PEQUENO.mp4", alt: "Avatar fazendo o sinal de Pequeno", context: "Usado para indicar tamanho pequeno" },
    { id: 15, title: "DENTRO", video: "CASA_MOVEIS/15_DENTRO.mp4", alt: "Avatar fazendo o sinal de Dentro", context: "Usado para indicar interior" },
    { id: 16, title: "FORA", video: "CASA_MOVEIS/16_FORA.mp4", alt: "Avatar fazendo o sinal de Fora", context: "Usado para indicar exterior" },
    { id: 17, title: "BARATO", video: "CASA_MOVEIS/17_BARATO.mp4", alt: "Avatar fazendo o sinal de Barato", context: "Usado para indicar preço baixo" },
    { id: 18, title: "CARO", video: "CASA_MOVEIS/18_CARO.mp4", alt: "Avatar fazendo o sinal de Caro", context: "Usado para indicar preço alto" },
    { id: 19, title: "MAIS", video: "CASA_MOVEIS/19_MAIS.mp4", alt: "Avatar fazendo o sinal de Mais", context: "Usado para indicar maior quantidade" },
    { id: 20, title: "POUCO", video: "CASA_MOVEIS/20_POUCO.mp4", alt: "Avatar fazendo o sinal de Pouco", context: "Usado para indicar menor quantidade" },
    { id: 21, title: "QUANTOS?", video: "CASA_MOVEIS/21_QUANTOS.mp4", alt: "Avatar fazendo o sinal de Quantos?", context: "Usado para perguntar quantidade" },
    { id: 22, title: "QUANTO CUSTA?", video: "CASA_MOVEIS/22_QUANTO_CUSTA.mp4", alt: "Avatar fazendo o sinal de Quanto Custa?", context: "Usado para perguntar preço" },
    { id: 23, title: "PERGUNTAR", video: "CASA_MOVEIS/23_PERGUNTAR.mp4", alt: "Avatar fazendo o sinal de Perguntar", context: "Usado para indicar ação de perguntar" },
    { id: 24, title: "RESPONDER", video: "CASA_MOVEIS/24_RESPONDER.mp4", alt: "Avatar fazendo o sinal de Responder", context: "Usado para indicar ação de responder" },
    { id: 25, title: "VER", video: "CASA_MOVEIS/25_VER.mp4", alt: "Avatar fazendo o sinal de Ver", context: "Usado para indicar ação de ver" },
    { id: 26, title: "NÃO VER", video: "CASA_MOVEIS/26_NÃO_VER.mp4", alt: "Avatar fazendo o sinal de Não Ver", context: "Usado para indicar que não viu" },
    { id: 27, title: "COMPRAR", video: "CASA_MOVEIS/27_COMPRAR.mp4", alt: "Avatar fazendo o sinal de Comprar", context: "Usado para indicar ação de comprar" },
    { id: 28, title: "VENDER", video: "CASA_MOVEIS/28_VENDER.mp4", alt: "Avatar fazendo o sinal de Vender", context: "Usado para indicar ação de vender" },
    { id: 29, title: "PAGAR", video: "CASA_MOVEIS/29_PAGAR.mp4", alt: "Avatar fazendo o sinal de Pagar", context: "Usado para indicar ação de pagar" }
];
