/* ============================================
   ...
   ============================================ */
const signals = [
    { id: 1, title: "PESSOAS", video: "PESSOAS_FAMILIA/1_PESSOAS.mp4", alt: "Avatar fazendo o sinal de Pessoas", context: "Usado para se referir a pessoas em geral" },
    { id: 2, title: "HOMEM", video: "PESSOAS_FAMILIA/2_HOMEM.mp4", alt: "Avatar fazendo o sinal de Homem", context: "Usado para se referir a um homem" },
    { id: 3, title: "MULHER", video: "PESSOAS_FAMILIA/3_MULHER.mp4", alt: "Avatar fazendo o sinal de Mulher", context: "Usado para se referir a uma mulher" },
    { id: 4, title: "FAMÍLIA", video: "PESSOAS_FAMILIA/4_FAMÍLIA.mp4", alt: "Avatar fazendo o sinal de Família", context: "Usado para se referir à família" },
    { id: 5, title: "PAI", video: "PESSOAS_FAMILIA/5_PAI.mp4", alt: "Avatar fazendo o sinal de Pai", context: "Usado para se referir ao pai" },
    { id: 6, title: "MÃE", video: "PESSOAS_FAMILIA/6_MÃE.mp4", alt: "Avatar fazendo o sinal de Mãe", context: "Usado para se referir à mãe" },
    { id: 7, title: "AVÓ", video: "PESSOAS_FAMILIA/7_AVÓ.mp4", alt: "Avatar fazendo o sinal de Avó", context: "Usado para se referir à avó" },
    { id: 8, title: "IRMÃO", video: "PESSOAS_FAMILIA/8_IRMÃO.mp4", alt: "Avatar fazendo o sinal de Irmão", context: "Usado para se referir ao irmão" },
    { id: 9, title: "TIO", video: "PESSOAS_FAMILIA/9_TIO.mp4", alt: "Avatar fazendo o sinal de Tio", context: "Usado para se referir ao tio" },
    { id: 10, title: "PRIMO", video: "PESSOAS_FAMILIA/10_PRIMO.mp4", alt: "Avatar fazendo o sinal de Primo", context: "Usado para se referir ao primo" },
    { id: 11, title: "SOBRINHO", video: "PESSOAS_FAMILIA/11_SOBRINHO.mp4", alt: "Avatar fazendo o sinal de Sobrinho", context: "Usado para se referir ao sobrinho" },
    { id: 12, title: "AMIGO", video: "PESSOAS_FAMILIA/12_AMIGO.mp4", alt: "Avatar fazendo o sinal de Amigo", context: "Usado para se referir a um amigo" },
    { id: 13, title: "CRIANÇA", video: "PESSOAS_FAMILIA/13_CRIANÇA.mp4", alt: "Avatar fazendo o sinal de Criança", context: "Usado para se referir a uma criança" },
    { id: 14, title: "JOVEM", video: "PESSOAS_FAMILIA/14_JOVEM.mp4", alt: "Avatar fazendo o sinal de Jovem", context: "Usado para se referir a um jovem" },
    { id: 15, title: "ADULTO", video: "PESSOAS_FAMILIA/15_ADULTO.mp4", alt: "Avatar fazendo o sinal de Adulto", context: "Usado para se referir a um adulto" },
    { id: 16, title: "IDOSO", video: "PESSOAS_FAMILIA/16_IDOSO.mp4", alt: "Avatar fazendo o sinal de Idoso", context: "Usado para se referir a um idoso" },
    { id: 17, title: "SOLTEIRO", video: "PESSOAS_FAMILIA/17_SOLTEIRO.mp4", alt: "Avatar fazendo o sinal de Solteiro", context: "Usado para indicar estado civil solteiro" },
    { id: 18, title: "NOIVO", video: "PESSOAS_FAMILIA/18_NOIVO.mp4", alt: "Avatar fazendo o sinal de Noivo", context: "Usado para se referir a noivo" },
    { id: 19, title: "CASADO", video: "PESSOAS_FAMILIA/19_CASADO.mp4", alt: "Avatar fazendo o sinal de Casado", context: "Usado para indicar estado civil casado" },
    { id: 20, title: "DOCUMENTO", video: "PESSOAS_FAMILIA/20_DOCUMENTO.mp4", alt: "Avatar fazendo o sinal de Documento", context: "Usado para se referir a documentos" },
    { id: 21, title: "CERTIDÃO DE NASCIMENTO", video: "PESSOAS_FAMILIA/21_CERTIDÃO_DE_NASCIMENTO.mp4", alt: "Avatar fazendo o sinal de Certidão de Nascimento", context: "Usado para se referir à certidão de nascimento" },
    { id: 22, title: "IDENTIDADE", video: "PESSOAS_FAMILIA/22_IDENTIDADE.mp4", alt: "Avatar fazendo o sinal de Identidade", context: "Usado para se referir ao documento de identidade" },
    { id: 23, title: "AGORA", video: "PESSOAS_FAMILIA/23_AGORA.mp4", alt: "Avatar fazendo o sinal de Agora", context: "Usado para indicar o momento presente" },
    { id: 24, title: "BEM", video: "PESSOAS_FAMILIA/24_BEM.mp4", alt: "Avatar fazendo o sinal de Bem", context: "Usado para indicar algo bom ou bem-estar" },
    { id: 25, title: "RUIM", video: "PESSOAS_FAMILIA/25_RUIM.mp4", alt: "Avatar fazendo o sinal de Ruim", context: "Usado para indicar algo ruim" },
    { id: 26, title: "CERTO", video: "PESSOAS_FAMILIA/26_CERTO.mp4", alt: "Avatar fazendo o sinal de Certo", context: "Usado para indicar correção ou certeza" },
    { id: 27, title: "ERRADO", video: "PESSOAS_FAMILIA/27_ERRADO.mp4", alt: "Avatar fazendo o sinal de Errado", context: "Usado para indicar erro" },
    { id: 28, title: "O QUÊ?", video: "PESSOAS_FAMILIA/28_O_QUÊ.mp4", alt: "Avatar fazendo o sinal de O quê?", context: "Usado para fazer perguntas sobre algo" },
    { id: 29, title: "POR QUE", video: "PESSOAS_FAMILIA/29_POR_QUE.mp4", alt: "Avatar fazendo o sinal de Por que", context: "Usado para perguntar a razão de algo" },
    { id: 30, title: "QUEM?", video: "PESSOAS_FAMILIA/30_QUEM.mp4", alt: "Avatar fazendo o sinal de Quem?", context: "Usado para perguntar sobre uma pessoa" },
    { id: 31, title: "ACONTECER", video: "PESSOAS_FAMILIA/31_ACONTECER.mp4", alt: "Avatar fazendo o sinal de Acontecer", context: "Usado para indicar que algo aconteceu" },
    { id: 32, title: "CAIR", video: "PESSOAS_FAMILIA/32_CAIR.mp4", alt: "Avatar fazendo o sinal de Cair", context: "Usado para indicar queda" },
    { id: 33, title: "ABRAÇAR", video: "PESSOAS_FAMILIA/33_ABRAÇAR.mp4", alt: "Avatar fazendo o sinal de Abraçar", context: "Usado para indicar abraço" },
    { id: 34, title: "BEIJAR", video: "PESSOAS_FAMILIA/34_BEIJAR.mp4", alt: "Avatar fazendo o sinal de Beijar", context: "Usado para indicar beijo" },
    { id: 35, title: "CONVERSAR", video: "PESSOAS_FAMILIA/35_CONVERSAR.mp4", alt: "Avatar fazendo o sinal de Conversar", context: "Usado para indicar conversa" },
    { id: 36, title: "AMAR", video: "PESSOAS_FAMILIA/36_AMAR.mp4", alt: "Avatar fazendo o sinal de Amar", context: "Usado para expressar amor" },
    { id: 37, title: "AVISAR", video: "PESSOAS_FAMILIA/37_AVISAR.mp4", alt: "Avatar fazendo o sinal de Avisar", context: "Usado para indicar aviso" },
    { id: 38, title: "DAR", video: "PESSOAS_FAMILIA/38_DAR.mp4", alt: "Avatar fazendo o sinal de Dar", context: "Usado para indicar ação de dar" },
    { id: 39, title: "RECEBER", video: "PESSOAS_FAMILIA/39_RECEBER.mp4", alt: "Avatar fazendo o sinal de Receber", context: "Usado para indicar ação de receber" },
    { id: 40, title: "GOSTAR", video: "PESSOAS_FAMILIA/40_GOSTAR.mp4", alt: "Avatar fazendo o sinal de Gostar", context: "Usado para expressar que gosta de algo" },
    { id: 41, title: "NÃO GOSTAR", video: "PESSOAS_FAMILIA/41_NÃO_GOSTAR.mp4", alt: "Avatar fazendo o sinal de Não Gostar", context: "Usado para expressar que não gosta de algo" },
    { id: 42, title: "TER", video: "PESSOAS_FAMILIA/42_TER.mp4", alt: "Avatar fazendo o sinal de Ter", context: "Usado para indicar posse" },
    { id: 43, title: "NÃO TER", video: "PESSOAS_FAMILIA/43_NÃO_TER.mp4", alt: "Avatar fazendo o sinal de Não Ter", context: "Usado para indicar ausência de posse" }
];
