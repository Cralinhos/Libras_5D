/* ============================================
   ...
   - Array com todos os sinais de profissões
   - Cada sinal tem: id, título, vídeo, alt, contexto
   ============================================ */
const signals = [
    { id: 1, title: "DIRETOR", video: "PROFISSOES/1_DIRETOR.mp4", alt: "Avatar fazendo o sinal de Diretor", context: "Usado para se referir ao diretor" },
    { id: 2, title: "MÉDICO", video: "PROFISSOES/2_MÉDICO.mp4", alt: "Avatar fazendo o sinal de Médico", context: "Usado para se referir ao médico" },
    { id: 3, title: "MOTORISTA", video: "PROFISSOES/3_MOTORISTA.mp4", alt: "Avatar fazendo o sinal de Motorista", context: "Usado para se referir ao motorista" },
    { id: 4, title: "SECRETARIA", video: "PROFISSOES/4_SECRETARIA.mp4", alt: "Avatar fazendo o sinal de Secretaria", context: "Usado para se referir à secretária" },
    { id: 5, title: "PEDREIRO", video: "PROFISSOES/5_PEDREIRO.mp4", alt: "Avatar fazendo o sinal de Pedreiro", context: "Usado para se referir ao pedreiro" },
    { id: 6, title: "PROFESSORA", video: "PROFISSOES/6_PROFESSORA.mp4", alt: "Avatar fazendo o sinal de Professora", context: "Usado para se referir à professora" },
    { id: 7, title: "BOMBEIRO", video: "PROFISSOES/7_BOMBEIRO.mp4", alt: "Avatar fazendo o sinal de Bombeiro", context: "Usado para se referir ao bombeiro" },
    { id: 8, title: "MECÂNICO", video: "PROFISSOES/8_MECÂNICO.mp4", alt: "Avatar fazendo o sinal de Mecânico", context: "Usado para se referir ao mecânico" },
    { id: 9, title: "EMPREGADA DOMÉSTICA", video: "PROFISSOES/9_EMPREGADA_DOMÉSTICA.mp4", alt: "Avatar fazendo o sinal de Empregada Doméstica", context: "Usado para se referir à empregada doméstica" },
    { id: 10, title: "COSTUREIRA", video: "PROFISSOES/10_COSTUREIRA.mp4", alt: "Avatar fazendo o sinal de Costureira", context: "Usado para se referir à costureira" },
    { id: 11, title: "FUNCIONÁRIO PÚBLICO", video: "PROFISSOES/11_FUNCIONÁRIO_PÚBLICO.mp4", alt: "Avatar fazendo o sinal de Funcionário Público", context: "Usado para se referir ao funcionário público" },
    { id: 12, title: "ADVOGADO", video: "PROFISSOES/12_ADVOGADO.mp4", alt: "Avatar fazendo o sinal de Advogado", context: "Usado para se referir ao advogado" },
    { id: 13, title: "CHEFE/GERENTE", video: "PROFISSOES/13_CHEFE_GERENTE.mp4", alt: "Avatar fazendo o sinal de Chefe/Gerente", context: "Usado para se referir ao chefe ou gerente" },
    { id: 14, title: "ENFERMEIRA", video: "PROFISSOES/14_ENFERMEIRA.mp4", alt: "Avatar fazendo o sinal de Enfermeira", context: "Usado para se referir à enfermeira" },
    { id: 15, title: "SAÚDE", video: "PROFISSOES/15_SAÚDE.mp4", alt: "Avatar fazendo o sinal de Saúde", context: "Usado para se referir à saúde" },
    { id: 16, title: "DOENÇA", video: "PROFISSOES/16_DOENÇA.mp4", alt: "Avatar fazendo o sinal de Doença", context: "Usado para indicar doença" },
    { id: 17, title: "SANGUE", video: "PROFISSOES/17_SANGUE.mp4", alt: "Avatar fazendo o sinal de Sangue", context: "Usado para se referir ao sangue" },
    { id: 18, title: "CORAÇÃO", video: "PROFISSOES/18_CORAÇÃO.mp4", alt: "Avatar fazendo o sinal de Coração", context: "Usado para se referir ao coração" },
    { id: 19, title: "TONTURA", video: "PROFISSOES/19_TONTURA.mp4", alt: "Avatar fazendo o sinal de Tontura", context: "Usado para indicar tontura" },
    { id: 20, title: "ENJOO", video: "PROFISSOES/20_ENJOO.mp4", alt: "Avatar fazendo o sinal de Enjoo", context: "Usado para indicar enjoo" },
    { id: 21, title: "VÔMITO", video: "PROFISSOES/21_VÔMITO.mp4", alt: "Avatar fazendo o sinal de Vômito", context: "Usado para indicar vômito" },
    { id: 22, title: "DIARRÉIA", video: "PROFISSOES/22_DIARRÉIA.mp4", alt: "Avatar fazendo o sinal de Diarréia", context: "Usado para indicar diarréia" },
    { id: 23, title: "FRATURA", video: "PROFISSOES/23_FRATURA.mp4", alt: "Avatar fazendo o sinal de Fratura", context: "Usado para indicar fratura" },
    { id: 24, title: "QUEIMADURA", video: "PROFISSOES/24_QUEIMADURA.mp4", alt: "Avatar fazendo o sinal de Queimadura", context: "Usado para indicar queimadura" },
    { id: 25, title: "CHOQUE ELÉTRICO", video: "PROFISSOES/25_CHOQUE_ELÉTRICO.mp4", alt: "Avatar fazendo o sinal de Choque Elétrico", context: "Usado para indicar choque elétrico" },
    { id: 26, title: "AFOGAMENTO", video: "PROFISSOES/26_AFOGAMENTO.mp4", alt: "Avatar fazendo o sinal de Afogamento", context: "Usado para indicar afogamento" },
    { id: 27, title: "VENENO", video: "PROFISSOES/27_VENENO.mp4", alt: "Avatar fazendo o sinal de Veneno", context: "Usado para indicar veneno" },
    { id: 28, title: "MORDEDURA DE ANIMAIS", video: "PROFISSOES/28_MORDEDURA_DE_ANIMAIS.mp4", alt: "Avatar fazendo o sinal de Mordedura de Animais", context: "Usado para indicar mordedura de animais" },
    { id: 29, title: "ATROPELAMENTO", video: "PROFISSOES/29_ATROPELAMENTO.mp4", alt: "Avatar fazendo o sinal de Atropelamento", context: "Usado para indicar atropelamento" },
    { id: 30, title: "DOR", video: "PROFISSOES/30_DOR.mp4", alt: "Avatar fazendo o sinal de Dor", context: "Usado para indicar dor" },
    { id: 31, title: "HOSPITAL", video: "PROFISSOES/31_HOSPITAL.mp4", alt: "Avatar fazendo o sinal de Hospital", context: "Usado para se referir ao hospital" },
    { id: 32, title: "FARMÁCIA", video: "PROFISSOES/32_FARMÁCIA.mp4", alt: "Avatar fazendo o sinal de Farmácia", context: "Usado para se referir à farmácia" },
    { id: 33, title: "REMÉDIO", video: "PROFISSOES/33_REMÉDIO.mp4", alt: "Avatar fazendo o sinal de Remédio", context: "Usado para se referir a remédio" },
    { id: 34, title: "SENTIR", video: "PROFISSOES/34_SENTIR.mp4", alt: "Avatar fazendo o sinal de Sentir", context: "Usado para indicar sentimento" },
    { id: 35, title: "TIPO (OPÇÃO)", video: "PROFISSOES/35_TIPO_OPÇÃO.mp4", alt: "Avatar fazendo o sinal de Tipo", context: "Usado para indicar tipo ou opção" },
    { id: 36, title: "BRAVO", video: "PROFISSOES/36_BRAVO.mp4", alt: "Avatar fazendo o sinal de Bravo", context: "Usado para indicar braveza ou raiva" }
];
