/* ============================================
   ...
   ============================================ */
const signals = [
    { id: 1, title: "PROFESSOR", video: "PROFISSOES/1_PROFESSOR.mp4", alt: "Avatar fazendo o sinal de Professor", context: "Usado para se referir ao professor ou professora" },
    { id: 2, title: "MÉDICO", video: "PROFISSOES/2_MÉDICO.mp4", alt: "Avatar fazendo o sinal de Médico", context: "Usado para se referir ao médico ou médica" },
    { id: 3, title: "ENFERMEIRO", video: "PROFISSOES/3_ENFERMEIRO.mp4", alt: "Avatar fazendo o sinal de Enfermeiro", context: "Usado para se referir ao enfermeiro ou enfermeira" },
    { id: 4, title: "POLICIAL", video: "PROFISSOES/4_POLICIAL.mp4", alt: "Avatar fazendo o sinal de Policial", context: "Usado para se referir ao policial" },
    { id: 5, title: "BOMBEIRO", video: "PROFISSOES/5_BOMBEIRO.mp4", alt: "Avatar fazendo o sinal de Bombeiro", context: "Usado para se referir ao bombeiro" },
    { id: 6, title: "ADVOGADO", video: "PROFISSOES/6_ADVOGADO.mp4", alt: "Avatar fazendo o sinal de Advogado", context: "Usado para se referir ao advogado ou advogada" },
    { id: 7, title: "ENGENHEIRO", video: "PROFISSOES/7_ENGENHEIRO.mp4", alt: "Avatar fazendo o sinal de Engenheiro", context: "Usado para se referir ao engenheiro ou engenheira" },
    { id: 8, title: "DENTISTA", video: "PROFISSOES/8_DENTISTA.mp4", alt: "Avatar fazendo o sinal de Dentista", context: "Usado para se referir ao dentista" },
    { id: 9, title: "COZINHEIRO", video: "PROFISSOES/9_COZINHEIRO.mp4", alt: "Avatar fazendo o sinal de Cozinheiro", context: "Usado para se referir ao cozinheiro ou cozinheira" },
    { id: 10, title: "MOTORISTA", video: "PROFISSOES/10_MOTORISTA.mp4", alt: "Avatar fazendo o sinal de Motorista", context: "Usado para se referir ao motorista" },
    { id: 11, title: "PINTOR", video: "PROFISSOES/11_PINTOR.mp4", alt: "Avatar fazendo o sinal de Pintor", context: "Usado para se referir ao pintor ou pintora" },
    { id: 12, title: "MECÂNICO", video: "PROFISSOES/12_MECÂNICO.mp4", alt: "Avatar fazendo o sinal de Mecânico", context: "Usado para se referir ao mecânico ou mecânica" },
    { id: 13, title: "ESTUDANTE", video: "PROFISSOES/13_ESTUDANTE.mp4", alt: "Avatar fazendo o sinal de Estudante", context: "Usado para se referir ao estudante" },
    { id: 14, title: "TRABALHO", video: "PROFISSOES/14_TRABALHO.mp4", alt: "Avatar fazendo o sinal de Trabalho", context: "Usado para se referir ao trabalho em geral" }
];
