/* ============================================
   ...
   - Array com todos os sinais de meses/alimentos/bebidas
   - Cada sinal tem: id, título, vídeo, alt, contexto
   ============================================ */
const signals = [
    { id: 1, title: "MESES", video: "MESES_ALIMENTOS/1_MESES.mp4", alt: "Avatar fazendo o sinal de Meses", context: "Usado para se referir aos meses" },
    { id: 2, title: "JANEIRO", video: "MESES_ALIMENTOS/2_JANEIRO.mp4", alt: "Avatar fazendo o sinal de Janeiro", context: "Usado para se referir a janeiro" },
    { id: 3, title: "FEVEREIRO", video: "MESES_ALIMENTOS/3_FEVEREIRO.mp4", alt: "Avatar fazendo o sinal de Fevereiro", context: "Usado para se referir a fevereiro" },
    { id: 4, title: "M-A-R-C-O (datilologia)", video: "MESES_ALIMENTOS/4_MARCO.mp4", alt: "Avatar fazendo o sinal de Março", context: "Usado para se referir a março" },
    { id: 5, title: "ABRIL", video: "MESES_ALIMENTOS/5_ABRIL.mp4", alt: "Avatar fazendo o sinal de Abril", context: "Usado para se referir a abril" },
    { id: 6, title: "M-A-I-O (datilologia)", video: "MESES_ALIMENTOS/6_MAIO.mp4", alt: "Avatar fazendo o sinal de Maio", context: "Usado para se referir a maio" },
    { id: 7, title: "JUNHO", video: "MESES_ALIMENTOS/7_JUNHO.mp4", alt: "Avatar fazendo o sinal de Junho", context: "Usado para se referir a junho" },
    { id: 8, title: "AGOSTO", video: "MESES_ALIMENTOS/8_AGOSTO.mp4", alt: "Avatar fazendo o sinal de Agosto", context: "Usado para se referir a agosto" },
    { id: 9, title: "JULHO", video: "MESES_ALIMENTOS/9_JULHO.mp4", alt: "Avatar fazendo o sinal de Julho", context: "Usado para se referir a julho" },
    { id: 10, title: "SETEMBRO", video: "MESES_ALIMENTOS/10_SETEMBRO.mp4", alt: "Avatar fazendo o sinal de Setembro", context: "Usado para se referir a setembro" },
    { id: 11, title: "OUTUBRO", video: "MESES_ALIMENTOS/11_OUTUBRO.mp4", alt: "Avatar fazendo o sinal de Outubro", context: "Usado para se referir a outubro" },
    { id: 12, title: "NOVEMBRO", video: "MESES_ALIMENTOS/12_NOVEMBRO.mp4", alt: "Avatar fazendo o sinal de Novembro", context: "Usado para se referir a novembro" },
    { id: 13, title: "DEZEMBRO", video: "MESES_ALIMENTOS/13_DEZEMBRO.mp4", alt: "Avatar fazendo o sinal de Dezembro", context: "Usado para se referir a dezembro" },
    { id: 14, title: "ALIMENTOS", video: "MESES_ALIMENTOS/14_ALIMENTOS.mp4", alt: "Avatar fazendo o sinal de Alimentos", context: "Usado para se referir a alimentos" },
    { id: 15, title: "ARROZ", video: "MESES_ALIMENTOS/15_ARROZ.mp4", alt: "Avatar fazendo o sinal de Arroz", context: "Usado para se referir ao arroz" },
    { id: 16, title: "FEIJÃO", video: "MESES_ALIMENTOS/16_FEIJÃO.mp4", alt: "Avatar fazendo o sinal de Feijão", context: "Usado para se referir ao feijão" },
    { id: 17, title: "MACARRÃO", video: "MESES_ALIMENTOS/17_MACARRÃO.mp4", alt: "Avatar fazendo o sinal de Macarrão", context: "Usado para se referir ao macarrão" },
    { id: 18, title: "OVO", video: "MESES_ALIMENTOS/18_OVO.mp4", alt: "Avatar fazendo o sinal de Ovo", context: "Usado para se referir ao ovo" },
    { id: 19, title: "CARNE", video: "MESES_ALIMENTOS/19_CARNE.mp4", alt: "Avatar fazendo o sinal de Carne", context: "Usado para se referir à carne" },
    { id: 20, title: "AÇÚCAR", video: "MESES_ALIMENTOS/20_AÇÚCAR.mp4", alt: "Avatar fazendo o sinal de Açúcar", context: "Usado para se referir ao açúcar" },
    { id: 21, title: "SAL", video: "MESES_ALIMENTOS/21_SAL.mp4", alt: "Avatar fazendo o sinal de Sal", context: "Usado para se referir ao sal" },
    { id: 22, title: "MAÇÃ", video: "MESES_ALIMENTOS/22_MAÇÃ.mp4", alt: "Avatar fazendo o sinal de Maçã", context: "Usado para se referir à maçã" },
    { id: 23, title: "MAMÃO", video: "MESES_ALIMENTOS/23_MAMÃO.mp4", alt: "Avatar fazendo o sinal de Mamão", context: "Usado para se referir ao mamão" },
    { id: 24, title: "BANANA", video: "MESES_ALIMENTOS/24_BANANA.mp4", alt: "Avatar fazendo o sinal de Banana", context: "Usado para se referir à banana" },
    { id: 25, title: "MELANCIA", video: "MESES_ALIMENTOS/25_MELANCIA.mp4", alt: "Avatar fazendo o sinal de Melancia", context: "Usado para se referir à melancia" },
    { id: 26, title: "BEBIDAS", video: "MESES_ALIMENTOS/26_BEBIDAS.mp4", alt: "Avatar fazendo o sinal de Bebidas", context: "Usado para se referir a bebidas" },
    { id: 27, title: "REFRIGERANTE", video: "MESES_ALIMENTOS/27_REFRIGERANTE.mp4", alt: "Avatar fazendo o sinal de Refrigerante", context: "Usado para se referir ao refrigerante" },
    { id: 28, title: "SUCO", video: "MESES_ALIMENTOS/28_SUCO.mp4", alt: "Avatar fazendo o sinal de Suco", context: "Usado para se referir ao suco" },
    { id: 29, title: "CAFÉ", video: "MESES_ALIMENTOS/29_CAFÉ.mp4", alt: "Avatar fazendo o sinal de Café", context: "Usado para se referir ao café" },
    { id: 30, title: "CACHAÇA/PINGA", video: "MESES_ALIMENTOS/30_CACHAÇA_PINGA.mp4", alt: "Avatar fazendo o sinal de Cachaça/Pinga", context: "Usado para se referir à cachaça ou pinga" },
    { id: 31, title: "RESTAURANTE", video: "MESES_ALIMENTOS/31_RESTAURANTE.mp4", alt: "Avatar fazendo o sinal de Restaurante", context: "Usado para se referir ao restaurante" },
    { id: 32, title: "B-A-R (datilologia)", video: "MESES_ALIMENTOS/32_BAR.mp4", alt: "Avatar fazendo o sinal de Bar", context: "Usado para se referir ao bar" },
    { id: 33, title: "PADARIA", video: "MESES_ALIMENTOS/33_PADARIA.mp4", alt: "Avatar fazendo o sinal de Padaria", context: "Usado para se referir à padaria" },
    { id: 34, title: "SUPERMERCADO", video: "MESES_ALIMENTOS/34_SUPERMERCADO.mp4", alt: "Avatar fazendo o sinal de Supermercado", context: "Usado para se referir ao supermercado" },
    { id: 35, title: "LEMBRAR", video: "MESES_ALIMENTOS/35_LEMBRAR.mp4", alt: "Avatar fazendo o sinal de Lembrar", context: "Usado para indicar lembrança" },
    { id: 36, title: "ESQUECER", video: "MESES_ALIMENTOS/36_ESQUECER.mp4", alt: "Avatar fazendo o sinal de Esquecer", context: "Usado para indicar esquecimento" },
    { id: 37, title: "PODER", video: "MESES_ALIMENTOS/37_PODER.mp4", alt: "Avatar fazendo o sinal de Poder", context: "Usado para indicar capacidade" },
    { id: 38, title: "NÃO PODER", video: "MESES_ALIMENTOS/38_NÃO_PODER.mp4", alt: "Avatar fazendo o sinal de Não Poder", context: "Usado para indicar incapacidade" },
    { id: 39, title: "FALTAR (Objetos)", video: "MESES_ALIMENTOS/39_FALTAR_OBJETOS.mp4", alt: "Avatar fazendo o sinal de Faltar (Objetos)", context: "Usado para indicar falta de objetos" },
    { id: 40, title: "FALTAR (Pessoas)", video: "MESES_ALIMENTOS/40_FALTAR_PESSOAS.mp4", alt: "Avatar fazendo o sinal de Faltar (Pessoas)", context: "Usado para indicar falta/ausência de pessoas" },
    { id: 41, title: "VOLTAR", video: "MESES_ALIMENTOS/41_VOLTAR.mp4", alt: "Avatar fazendo o sinal de Voltar", context: "Usado para indicar retorno" }
];
