/* ============================================
   ...
   ============================================ */
const signals = [
    { id: 1, title: "JANEIRO", video: "MESES_ALIMENTOS/1_JANEIRO.mp4", alt: "Avatar fazendo o sinal de Janeiro", context: "Usado para se referir ao primeiro mês do ano" },
    { id: 2, title: "FEVEREIRO", video: "MESES_ALIMENTOS/2_FEVEREIRO.mp4", alt: "Avatar fazendo o sinal de Fevereiro", context: "Usado para se refer ir ao segundo mês do ano" },
    { id: 3, title: "MARÇO", video: "MESES_ALIMENTOS/3_MARÇO.mp4", alt: "Avatar fazendo o sinal de Março", context: "Usado para se referir ao terceiro mês do ano" },
    { id: 4, title: "ABRIL", video: "MESES_ALIMENTOS/4_ABRIL.mp4", alt: "Avatar fazendo o sinal de Abril", context: "Usado para se referir ao quarto mês do ano" },
    { id: 5, title: "MAIO", video: "MESES_ALIMENTOS/5_MAIO.mp4", alt: "Avatar fazendo o sinal de Maio", context: "Usado para se referir ao quinto mês do ano" },
    { id: 6, title: "JUNHO", video: "MESES_ALIMENTOS/6_JUNHO.mp4", alt: "Avatar fazendo o sinal de Junho", context: "Usado para se referir ao sexto mês do ano" },
    { id: 7, title: "JULHO", video: "MESES_ALIMENTOS/7_JULHO.mp4", alt: "Avatar fazendo o sinal de Julho", context: "Usado para se referir ao sétimo mês do ano" },
    { id: 8, title: "AGOSTO", video: "MESES_ALIMENTOS/8_AGOSTO.mp4", alt: "Avatar fazendo o sinal de Agosto", context: "Usado para se referir ao oitavo mês do ano" },
    { id: 9, title: "SETEMBRO", video: "MESES_ALIMENTOS/9_SETEMBRO.mp4", alt: "Avatar fazendo o sinal de Setembro", context: "Usado para se referir ao nono mês do ano" },
    { id: 10, title: "OUTUBRO", video: "MESES_ALIMENTOS/10_OUTUBRO.mp4", alt: "Avatar fazendo o sinal de Outubro", context: "Usado para se referir ao décimo mês do ano" },
    { id: 11, title: "NOVEMBRO", video: "MESES_ALIMENTOS/11_NOVEMBRO.mp4", alt: "Avatar fazendo o sinal de Novembro", context: "Usado para se referir ao décimo primeiro mês do ano" },
    { id: 12, title: "DEZEMBRO", video: "MESES_ALIMENTOS/12_DEZEMBRO.mp4", alt: "Avatar fazendo o sinal de Dezembro", context: "Usado para se referir ao décimo segundo mês do ano" },
    { id: 13, title: "PÃO", video: "MESES_ALIMENTOS/13_PÃO.mp4", alt: "Avatar fazendo o sinal de Pão", context: "Usado para se referir ao pão" },
    { id: 14, title: "LEITE", video: "MESES_ALIMENTOS/14_LEITE.mp4", alt: "Avatar fazendo o sinal de Leite", context: "Usado para se referir ao leite" },
    { id: 15, title: "ÁGUA", video: "MESES_ALIMENTOS/15_ÁGUA.mp4", alt: "Avatar fazendo o sinal de Água", context: "Usado para se referir à água" },
    { id: 16, title: "CAFÉ", video: "MESES_ALIMENTOS/16_CAFÉ.mp4", alt: "Avatar fazendo o sinal de Café", context: "Usado para se referir ao café" },
    { id: 17, title: "SUCO", video: "MESES_ALIMENTOS/17_SUCO.mp4", alt: "Avatar fazendo o sinal de Suco", context: "Usado para se referir ao suco" },
    { id: 18, title: "ARROZ", video: "MESES_ALIMENTOS/18_ARROZ.mp4", alt: "Avatar fazendo o sinal de Arroz", context: "Usado para se referir ao arroz" },
    { id: 19, title: "FEIJÃO", video: "MESES_ALIMENTOS/19_FEIJÃO.mp4", alt: "Avatar fazendo o sinal de Feijão", context: "Usado para se referir ao feijão" },
    { id: 20, title: "CARNE", video: "MESES_ALIMENTOS/20_CARNE.mp4", alt: "Avatar fazendo o sinal de Carne", context: "Usado para se referir à carne" }
];
